...
import { BusinessRulesComponent } from 'src/app/business-rules/business-rules.component';
import { AddDiscountComponent } from 'src/app/shared/modals/add-discount/add-discount.component';
import { MembershipComponent } from 'src/app/membership/membership.component';
import { ExhibitorComponent } from 'src/app/exhibitor/exhibitor.component';
import { CreateQualificationComponent } from 'src/app/shared/modals/create-qualification/create-qualification.component';
import * as moment from 'moment';
import { environment } from 'src/environments/environment';
import { ToastService } from 'src/app/services/toast/toast.service';
import { LocalStorageService } from 'src/app/services/local-storage.service';
import { countryCodes } from 'src/app/shared/countryCodes';
import { v4 as uuid } from 'uuid';
import { CdkDragDrop, moveItemInArray } from '@angular/cdk/drag-drop';
import { of } from 'rxjs';
import { UploadService } from 'src/app/services/upload.service';
import { DomSanitizer } from '@angular/platform-browser';
import { QuestionData } from 'src/app/shared/interfaces/Question';
import { ImportQuestionsComponent } from 'src/app/shared/modals/import-questions/import-questions.component';
import { DuplicateEventComponent } from 'src/app/shared/modals/duplicate-event/duplicate-event.component';
import { RegtypeData } from 'src/app/shared/interfaces/Regtype';
import { EventCostData, RateData } from 'src/app/shared/interfaces/EventCost';
...
export class EditEventComponent implements OnInit, AfterViewInit {
  ...
  customPackageForm = new FormGroup({
  ...
  private EDIT_EVENT_API =
    API_URL2 + '/csi/event/services/eventSetupV2/editEvent';
  ...
  eventCosts = [];
  regCodes = [];
  customIsZero: boolean = false;
  public myEventID: any;
  list1: any[];
  list2: any[];
  eventID = '0';
  postId = '';
  ...
  // Qualifications tab
  qualificationRegTypeArray = [];
  qualifications: string[] = ['taxIDNumber', 'payStub', 'busLi', 'photoID'];
  ...
  metricsActiveTab = 2; //used to switch in the navbar under Event Metrics tab
  ...
  setMetricsActiveTab(tabNo) {
    this.metricsActiveTab = tabNo;
  }
  get package() {
    return this.customPackageForm.controls;
  }
  ...
  public publishPaperBits() {
    if (this.builderPublishing == true) {
      alert('Please wait for the publisher to finish publishing');
      return;
    }
  ...
  jobs = [
    {
      category: 'Attendee',
      question: 'Please enter your exact job title:',
      PollingType: 'Registration',
    },
    {
      category: 'Attendee',
      question: 'Is your company/organization exhibiting at this event?',
      PollingType: 'Registration',
    },
    {
    ...
    },
    {
      category: 'Press / Media',
      question:
        "What is your media outlet's circulation/listnership/UVM/viewership? Please indicate which metric. We may ask for verification, i.e., BPA statement, Nielsen rating or recent monthly traffic report from a web analytics service, like Google Analytics.",
      PollingType: 'Qualification',
    },
    {
      category: 'Press / Media',
      question: 'Media Type',
    ...
    {
      category: 'Press / Media',
      question: 'What is your Circulation?',
      PollingType: 'Qualification',
    },
    {
      category: 'Press / Media',
      question: 'Please enter your publisher/media company/website:',
      PollingType: 'Qualification',
    },
    {
      category: 'Press / Media',
      question: 'Will you be working as Press at this event?',
      PollingType: 'Registration',
    },
    {
      category: 'Press / Media',
      question: 'Which metric are you providing?',
      PollingType: 'qualification',
    },
    {
      category: 'Press / Media',
      question: 'UVM : Please enter value:',
      PollingType: 'qualification',
    },
    {
      category: 'Press / Media',
      question: 'Listenership: Please enter value:',
      PollingType: 'qualification',
    },
    {
      category: 'Press / Media',
      question: 'Viewership: Please enter value',
      PollingType: 'qualification',
    },
    {
      category: 'Exhibitor',
    ...
    {
      category: 'Exhibitor',
      question: 'Is your company/organization presenting at this event?',
      PollingType: 'Registration',
    },
    {
      category: 'Student',
      question: 'Are you an graduate, intern or student?',
      PollingType: 'Registration',
    },
    {
      category: 'Student',
    ...
    {
      category: 'Student',
      question: 'Please enter your School Name',
      PollingType: 'Qualification',
    },
    {
      category: 'Attendee',
      question: 'Are you interested in meeting other attendees',
      PollingType: 'Interest',
    },
    {
      category: 'Attendee / Student',
      question: 'Student	Are you interested in attending social events',
      PollingType: 'Interest',
    },
    {
      category: 'Attendee',
      question: 'Are you interested in particular products',
      PollingType: 'Lead',
    },
    {
      category: 'Attendee',
      question: 'Are you interested in particular Exhibitors',
      PollingType: 'Lead',
    },
    {
      category: 'Attendee',
    ...
    {
      category: 'Attendee',
      question: 'Do you enjoy meeting people?',
      PollingType: 'Persona',
    },
    {
      category: 'Attendee / Exhibitor',
      question: 'Would you like to donate to the Scholarship fund?',
      PollingType: 'Donation',
    },
    {
      category: 'Attendee / Exhibitor',
      question: 'Will you need a Visa Letter',
      PollingType: 'Visa',
    },
    {
      category: 'Attendee / Exhibitor',
    ...
    {
      category: 'Attendee / Exhibitor',
      question: 'Are representing a company or industry',
      PollingType: 'Visa',
    },
    {
      category: 'Attendee / Exhibitor',
      question: 'Are you an association member?, Enter member id',
      PollingType: 'Qualification',
    },
    {
      category: 'Attendee / Exhibitor',
      question: 'Do you belong to a partner association? Please select',
      PollingType: 'Qualification',
    },
    {
      category: 'Attendee / Exhibitor',
      question:
        'What topic are you most interested in attending? Please select',
      PollingType: 'Interest',
    },
  ];
  ...
  themeModlRef;
  businessRulesMockData = [
    {
      ruleName: 'Custom Membership',
      trigger: 'Demographic Question Response',
      action: 'newPckg',
      appliesTo: ['attendee'],
      actionValues: null,
      packageDetails: {
        pckgName: 'package Name',
        pckgDesc: 'package description',
        pckgCost: '1000',
      },
      conditions: [
        {
          id: 'mem_q1',
          name: 'Membership',
          question: 'Question text will be displayed',
          rules: [
            {
              field: 'responseValue',
              operator: '=',
  ...
  @ViewChild(BusinessRulesComponent)
  ...
  constructor(
    ...
    if (this.sessionService.get('selectedEvent') != undefined) {
      ...
      // var EVENT_DATA_API = API_URL + "/csi/event/services/event/findById/" + this.myEventID;
      const EVENT_METRICS_API = `${API_URL}csi/event/services/event/getEventPOC/${this.myEventID}`;
      this.httpClient.get(EVENT_METRICS_API, { headers }).subscribe((data) => {
        if (data['response']['Error'] != undefined) {
          console.log(data['response']['Error']);
        } else {
          this.eventPOC = data['response'];
          console.log('this.eventPOC ', this.eventPOC);
        }
      });
      this.builderTemplate = this.defaultBuilderTemplate;
      this.builderTemplateType = [
        ...new Set(this.builderTemplate.map((item) => item.templateType)),
      ];
      ...
      this.httpClient.get(EVENT_DATA_API1, { headers }).subscribe((data) => {
        ...
        if (data && data['response'] && data['response']['Event']) {
          ...
          this.builderTemplate = this.builderTemplate?.map((template: any) => {
            return {
              ...template,
              checked:
                template.url === this.builderSelection ||
                template.url === this.exhibitorSelection ||
                template.url === this.organizerSelection,
            };
          });

          /** Set the builder Type(attendee) from the API(findAllEvtInfoByEvtUid) response but it is static now */
          this.builderType = this.builderTemplate[0].templateType;

          this.patchEventInfo(data);
          if (
            data['response']['noSessions'] ||
            data['response']['sessions'] === 'null' ||
            data['response']['sessions']?.length < 1
          ) {
            this.noSessions = true;
          } else {
            this.noSessions = false;
          }
          this.evtStartDate = new Date(data['response']['Event']['startDate']);
          this.evtUid = data['response']['Event']['evtuid'];
          this.addUserid = data['response']['Event']['addUserid'];
          this.tradeShowEvent = data['response']['Event']['tradeshowevent'];
          this.viewPublishedUrl =
            '/pages/' +
            slugify(data['response']['Event']['evtName'], { lower: true }) +
            '/' +
            this.myEventID;
          if (
            data['response']['EBlast'] &&
            data['response']['EBlast'].length > 0 &&
            data['response']['EBlast'] != 'null'
          ) {
            this.currentUsersEmail.push(...data['response']['EBlast']);
          }
          if (
          ...
          if (
            ...
            data['response']['EventCosts'].forEach((element) => {
              ...
              if (
                !this.customCategories.includes(
                  element.refCodes.slice(index + 2)
                )
              ) {
            ...
            this.qualificationRegTypeArray = this.jobsCategory;
          }
          if (
            data['response']['goals'] &&
            data['response']['goals'].length > 0
          ) {
            const currentGoals = this.goalElements;
            data['response']['goals'].forEach((data) => {
              currentGoals.forEach((goal) => {
                if (
                  data.goal == goal.goal &&
                  data.importance == goal.importance &&
                  data.PollingType == goal.PollingType
                ) {
                  goal.checked = true;
                  goal.responseValue = data.responseValue;
                }
              });
            });
            // this.mdbGoalTable.setDataSource(currentGoals);
          }
          if (
            ...
            this.searchQuestionText = questions[0]['category'];
          ...
          if (data['response']['eventFloorPlan']['floorPlanImageUrl']) {
          ...
          if (
            data['response']['customizations'] &&
            data['response']['customizations'] !== 'null'
          ) {
            console.log('customizations', data['response']['customizations']);
            if (Array.isArray(data['response']['customizations'])) {
              data['response']['customizations'].forEach((element) => {
                console.log(
                  'customizations',
                  element.config.attendeeResponse.passportExpirationDate,
                  element.config.attendeeResponse.passportExpirationDate ===
                    'true'
                );
                ...
                this.selectedCustomizations.push({
                  ...
                  config: {
                    ...
                    attendeeResponse: {
                      companyName:
                        element.config.attendeeResponse.companyName === 'true',
                      cszCountry:
                        element.config.attendeeResponse.cszCountry === 'true',
                      passportDob:
                        element.config.attendeeResponse.passportDob === 'true',
                      passportExpirationDate:
                        element.config.attendeeResponse
                          .passportExpirationDate === 'true',
                      passportGender:
                        element.config.attendeeResponse.passportGender ===
                        'true',
                      passportNumber:
                        element.config.attendeeResponse.passportNumber ===
                        'true',
                    },
                  },
                });
              ...
              this.selectedCustomizations.push({
                ...data['response']['customizations'],
                checked:
                  data['response']['customizations']['checked'] === 'true',
                config: {
                  ...data['response']['customizations']['config'],
                  attendeeResponse: {
                    companyName:
                      data['response']['customizations']['config'][
                        'attendeeResponse'
            ...
            console.log('customizations', this.selectedCustomizations);
          }
          if (
          ...
          if (
            ...
            this.exhibitorAllotmentData = data['response']['ExhibitorInfos'];
          }
          // const exhibitor_membership_data = JSON.parse(localStorage.getItem('exhibitor_membership_data'));
          // if(exhibitor_membership_data && this.myEventID == exhibitor_membership_data.evtuid){
          //   this.exhibitorAllotmentData = exhibitor_membership_data.data.exhibitor ? exhibitor_membership_data.data.exhibitor: [];
          //   this.membershipAllotmentData = exhibitor_membership_data.data.membership? exhibitor_membership_data.data.membership: [];
          // }
          ...
          if (
            ...
            this.membershipAllotmentData = data['response']['MembershipInfos'];
          }
          ...
          if (
            data['response']['businessRules'] &&
            data['response']['businessRules'] != 'null' &&
            this.businessRulesComponent
          ) {
            this.businessRulesComponent.apiData =
              data['response']['businessRules'];
            // this.businessRulesComponent.loadData();
            // if (data['response']['businessRules'].regTypeDeterm) {
            //   let regTypeDeterm = [];
            //   data['response']['businessRules'].regTypeDeterm.forEach(v => {
            //     regTypeDeterm.push(Object.values(v)[0]);
            //   });
            //   const patchVal = { regTypeDeterm } as any;
            //   const index = this.businessRulesComponent.Reg2EvtCodesSource.findIndex(
            //     x => x.id == data['response']['businessRules'].reg2EvtCode
            //   );

            //   if (index > -1) {
            //     patchVal.Reg2EvtCode =
            //       data['response']['businessRules'].reg2EvtCode;
            //   } else {
            //     patchVal.Reg2EvtCode = 'customField';
            //     patchVal.customField =
            //       data['response']['businessRules'].reg2EvtCode;
            //   }
            //   this.businessRulesComponent.businessRuleForm.patchValue(patchVal);
            // }
          }

          this.builderTemplate =
            data['response']['BuilderTemplates'] &&
            data['response']['BuilderTemplates'] != 'null'
              ? data['response']['BuilderTemplates'].map((ele) => ({
                  ...ele,
                  templateType: ele.templatetype,
                  includingPages: ele.includingpages,
                  themeType: ele.themetype,
                  templateName: ele.templatename,
                  checked: ele.checked === 'true' ? true : false,
                }))
              : this.defaultBuilderTemplate;
        ...
        if (!this.addUserid) {
          this.toastService.show(
            'Adduserid does not exist. Please refresh this page.',
            {
              delay: 6000,
              classname: 'bg-warning text-dark',
              headertext: 'Warning',
      ...
      const PAGEBUILDER_EVENT_DATA_API =
        API_URL +
        '/csi/event/services/event/getBuilderUuidsForEvent?evtUid=' +
        this.myEventID; //2567374";
      this.httpClient.get(PAGEBUILDER_EVENT_DATA_API, { headers }).subscribe((data: any) => {
        data.response.BuilderPageInfoList.map(
          (res) => (res.pageName = res.eventName)
        );
        this.customPages = data.response.BuilderPageInfoList;
      });
    } else {
  ...
  patchEventInfo(data) {
    this.eventInfoForm.patchValue({
      eventName: data['response']['Event']['evtName']
        ? data['response']['Event']['evtName'].split(' ').slice(0, -1).join(' ')
        : '',
      eventYear: data['response']['Event']['evtName']
        ? data['response']['Event']['evtName'].split(' ').slice(-1)[0]
        : '',
      description: data['response']['Event']['evtInfoText']
        ? data['response']['Event']['evtInfoText']
        : '',
      startDate: data['response']['Event']['startDate']
        ? this.formatDate(new Date(data['response']['Event']['startDate']))
        : '',
      startTime: data['response']['Event']['startTime']
        ? data['response']['Event']['startTime']
        : '',
      ...
      endTime: data['response']['Event']['endTime']
        ? data['response']['Event']['endTime']
        : '',
      eventSecurityLevel: data['response']['Event']['eventSecurityType']
        ? data['response']['Event']['eventSecurityType']
        : '',
      categories:
        data['response']['Category'] && data['response']['Category'].length > 0
          ? data['response']['Category'][0]['category']
          : [],
      googleMerchantId:
        data['response']['GooglePaymentData'] &&
        data['response']['GooglePaymentData'][0] &&
        data['response']['GooglePaymentData'][0]['paymentId']
          ? data['response']['GooglePaymentData'][0]['paymentId']
          : '',
      gateway:
        data['response']['GooglePaymentData'] &&
        data['response']['GooglePaymentData'][0] &&
        data['response']['GooglePaymentData'][0]['gateway']
          ? data['response']['GooglePaymentData'][0]['gateway']
          : '',
      gatewayMerchantId:
        data['response']['GooglePaymentData'] &&
        data['response']['GooglePaymentData'][0] &&
        data['response']['GooglePaymentData'][0]['gatewayID']
          ? data['response']['GooglePaymentData'][0]['gatewayID']
          : '',
      address1: data['response']['Event']['venueaddress1']
        ? data['response']['Event']['venueaddress1'].split(',')[0]
        : '',
      address2: data['response']['Event']['venueaddress2']
        ? data['response']['Event']['venueaddress2']
        : '',
      address3: data['response']['Event']['venueaddress3']
        ? data['response']['Event']['venueaddress3']
        : '',
      city: data['response']['Event']['venueCity']
        ? data['response']['Event']['venueCity']
        : '',
      county: data['response']['Event']['venuecounty']
        ? data['response']['Event']['venuecounty']
        : '',
      state: data['response']['Event']['venueState']
        ? data['response']['Event']['venueState']
        : '',
      countryCode: data['response']['Event']['venuecountrycd']
        ? data['response']['Event']['venuecountrycd']
        : '',
      country: data['response']['Event']['venuecountry']
        ? data['response']['Event']['venuecountry']
        : '',
      ...
      phone: data['response']['Event']['associationPhoneNumb']
        ? data['response']['Event']['associationPhoneNumb']
        : '',
      Seminar: data['response']['TypeOfEvent']
        ? data['response']['TypeOfEvent']['seminar'] &&
          data['response']['TypeOfEvent']['seminar'] == 'true'
          ? true
          : false
        : '',
      Social: data['response']['TypeOfEvent']
        ? data['response']['TypeOfEvent']['social'] &&
          data['response']['TypeOfEvent']['social'] == 'true'
          ? true
          : false
        : '',
      Trade: data['response']['TypeOfEvent']
        ? data['response']['TypeOfEvent']['trade'] &&
          data['response']['TypeOfEvent']['trade'] == 'true'
          ? true
          : false
        : '',
      Workshop: data['response']['TypeOfEvent']
        ? data['response']['TypeOfEvent']['workshop'] &&
          data['response']['TypeOfEvent']['workshop'] == 'true'
          ? true
          : false
        : '',
      eventFormat: data['response']['Event']['evtFormat']
        ? data['response']['Event']['evtFormat']
        : '',
      reqProjMgrName: data['response']['Event']['reqProjMgrName']
        ? data['response']['Event']['reqProjMgrName']
        : '',
      salesExecName: data['response']['Event']['salesExecName']
        ? data['response']['Event']['salesExecName']
        : '',
      custServicePhoneNumber: data['response']['Event'][
        'custServicePhoneNumber'
      ]
        ? data['response']['Event']['custServicePhoneNumber']
        : '',
      custServiceEmailAddress: data['response']['Event'][
    ...
    this.builderUrl = data['response']['Event']['builderURL']
      ? data['response']['Event']['builderURL']
      : '';
    ...
    this.exhibitorIOID = data['response']['Event']['exhibitorId']
      ? data['response']['Event']['exhibitorId']
      : '';
    this.organizerIOID = data['response']['Event']['organizerId']
      ? data['response']['Event']['organizerId']
      : '';
    ...
    console.log('this.builderUrl');
    console.log(this.builderUrl);
    console.log('this.builderIOID');
    console.log(this.builderIOID);

    this.eventInfoForm.controls.startDate.valueChanges.subscribe((val) => {
      this.evtStartDate = new Date(val);
    });
    this.defaultCountry = data['response']['Event']['venuecountry'];
  }
  ...
  //     if (!this.builderIOID) {
  //       this.launchBuilder = false;
  //       this.buildPage(0);
  //     }

  //     this.customPages.forEach(page => {
  //       this.pageBuilder.push({
  //         eventName: page.pageName,
  //         evtType: page.pageName.toLowerCase().replaceAll(' ', '-'),
  //         menuName: page.menuName,
  //         eventBuilderUuid: this.builderIOID
  //       });
  //     });
  //   }

  //   this.pageBuilderForm.controls.pageName.setValue('');
  //   this.pageBuilderForm.controls.pageName.markAsUntouched();
  //   this.pageBuilderForm.controls.pageName.markAsPristine();
  //   this.pageBuilderForm.controls.menuName.setValue('');
  //   this.pageBuilderForm.controls.menuName.markAsUntouched();
  //   this.pageBuilderForm.controls.menuName.markAsPristine();

  //   // console.log(this.customPages);
  // }

  // buildPage(idx: number) {
  //   var extraPageParam = this.customPages[idx]['pageName'];
  //   var extraPageParamSlug = extraPageParam.toLowerCase().replaceAll(' ', '-');
  //   var menuName = this.customPages[idx]['menuName'];
  //   if (this.customPages[idx]['eventBuilderUuid']) {
  //     var builderURL = 'builder/' + this.customPages[idx]['eventBuilderUuid'];
  //     window.open(builderURL, '_blank').focus();
  //   } else {
  //     this.generateBuilder(extraPageParam, extraPageParamSlug, menuName);
  //   }
  // }

  public removePage(idx: number) {
    this.customPages.splice(idx, 1);
    console.log('removePage');
  }

  // public generateBuilder(extraPageParam, extraPageParamSlug, menuName) {
  //   // if (menuName == 'Main') {
  //   //   console.log('this.pageBuilderForm before', this.pageBuilderForm);
  //   //   this.pageBuilderForm.controls.main.clearValidators();
  //   //   this.pageBuilderForm.controls.main.updateValueAndValidity();
  //   //   console.log('this.pageBuilderForm after', this.pageBuilderForm);
  //   // }
  //   this.getBuilderIOKey(extraPageParam, extraPageParamSlug, menuName);
  // }
  //comment
  // public getBuilderIOKey(extraPageParam, extraPageParamSlug, menuName) {
  //   if (this.isReadMode || menuName == 'Main') {
  //     var builderURL = 'builder/' + this.builderIOID;
  //     console.log(builderURL);
  //     window.open(builderURL, '_blank').focus();
  //   } else {
  //     var API_KEY = '95987ae43674442f9f69697d1ca04156';
  //     var FIELDS_RETURN = '&fields=id';
  //     //var BUILDER_IO_BASE_API = "https://builder.io/api/v2/content/page?apiKey="+ API_KEY;
  //     //var BUILDER_IO_BASE_API = "https://builder.io/api/v2/content/page?apiKey="+ API_KEY;
  //     //var BUILDER_WRITE_API = "https://builder.io/api/v1/write/page";
  //     // var BUILDER_WRITE_API2 = "https://builder.io/api/v2/write/page";
  //     var WRITE_API_KEY = 'bpk-bb11c305f0254a30ac6309395ffc540c';
  //     var PROXY_WRITE_API = 'https://builder.io/api/v1/write/page';
  //     var BUILDER_WRITE_API_URL = 'https://builder.io/api/v1/write/page';

  //     const headersAPI = new HttpHeaders()
  //       .set('Authorization', 'bearer ' + WRITE_API_KEY)
  //       .set('Access-Control-Allow-Methods', 'GET, POST, OPTIONS')
  //       .set('Access-Control-Allow-Origin', '*');
  ...
  //     var eventName = this.eventInfoForm.controls.eventName.value;

  //     if (eventName == '' || eventName == null) {
  //       pageName = 'Event Name';
  //       pageId = '/pages/' + 'event-name';
  //     } else {
  //       pageName = eventName;
  //       pageId = '/pages/' + slugify(eventName, { lower: true });
  //     }

  //     if (extraPageParam != '') {
  //       pageName = pageName + ' ' + extraPageParam;
  //     }

  //     if (extraPageParamSlug != '') {
  //       pageId = pageId + '_' + extraPageParamSlug;
  //     }
  ...
  //         this.builderIOID = responseJSON.id;

  //         var eventPageUid = {
  //           builderUuid: responseJSON.id,
  //           pageType: extraPageParamSlug,
  //           pageName: pageName,
  //           menuName: menuName
  //         };

  //         this.eventPages.push(eventPageUid);

  //         var builderURL = 'builder/' + this.builderIOID;
  //         if (this.launchBuilder) {
  //           window.open(builderURL, '_blank').focus();
  //         }
  //         this.launchBuilder = true;
  //       })
  //       .catch(error => {
  //         console.error(error);
  //       });
  ...
  changedDiscount(event: any) {
    ...
    this.addDiscountTypeDescript = $('#addDiscountTypeRef :selected').text();
  ...
  addDiscount() {
    ...
    // const existingDiscount = this.discountList.filter(discount => discount.discountType === this.addDiscountType);
    ...
    addDiscountRef.result.then((newDiscount) => {
  ...
  editDiscount(discount: any, index: number) {
    /** Enable the edit discount only when event start date less than the current Time */
    if (this.evtStartDate < this.currentTime) {
  ...
  public addQuestion(passedVal) {
    console.log('ADD QUESTION');
    this.questionsToDisplay.push(passedVal);
  }
  ...
  public addCSVUsers() {
    ...
    for (let i = 0, len = emailsSeparated.length; i < len; i++) {
      if (emailsSeparated[i] != '') {
        var myNewUser = {
          EmailAddrTxt: emailsSeparated[i].split(',')[2],
          NameFirst: emailsSeparated[i].split(',')[0],
          NameLast: emailsSeparated[i].split(',')[1],
        };
        this.currentUsersEmail.push({ ...myNewUser });
      }
    }
  }
  ...
  public processOnFileSelect(input: HTMLInputElement) {
  ...
  public addRegType(passedVal) {
    // if (this.regTypesToDisplay.includes(passedVal)) {
    //   return;
    // }

    // this.regTypesToDisplay.push(passedVal);
    ...
    // this.regTypeSearchResults = [];
  }

  public removeRegType(i) {
    // this.regTypesToDisplay.splice(i, 1);
  }

  // searchByRegType() {
  //   const thisSearchName = this.regTypeSearch
  //     ? this.regTypeSearch.toLowerCase()
  //     : '';
  //   const filteredOutArray = this.eventCosts.map((a) => a.refCodes);

  //   this.regTypeSearchResults = this.allRegCodes.filter(
  //     (el) =>
  //       el &&
  //       el.toLowerCase().includes(thisSearchName) &&
  //       !this.regTypesToDisplay.includes(el)
  //   );
  //   this.regTypeSearchResults = this.regTypeSearchResults.filter(
  //     (el) => !filteredOutArray.includes(el)
  //   );
  // }
  ...
  private editSession(index) {
    if (this.isReadMode || this.noSessions) {
      return;
    }
    this.editSesionIndex = index;
  ...
  public createEventProcess() {
    if (this.isEventNameFound() && !this.isReadMode) {
      alert('Duplicate event name');
      this.enableTab('eventInfoTab', false);
      return;
    }
    ...
    // if (this.isQuestionResultBtnDisabled && !this.isReadMode) {
    //   alert('Please select at least one Question');
    //   this.enableTab('regCodeTab', false);
    //   return;
    // }
  ...
  //   var createdEventID = this.myEventID;
  //   var creatorAttendeeID = localStorage.getItem("attendeeUid");

  //   var EXHIBITOR_API = API_URL + "/csi/event/services/liveEventServices/registerExhibitorToLiveEvent?evtUid=" + createdEventID + "&attendeeUid=" + creatorAttendeeID;
  ...
  //   this.httpClient.post<any>(EXHIBITOR_API, newExhibitor, { headers }).subscribe(data => {
  ...
  //         var ADD_SESSION_API = API_URL + "/csi/event/services/eventV2/createEventSession?evtUid=" + createdEventID + "&attendeeUid=" + creatorAttendeeID;
  ...
  //           "sessionAttendeeCapacity": sessionsToProcesss[x]['sessionAttendeeCapacity'],
  //         }

  //         console.log("Processing.... " + sessionsToProcesss[x]['name']);
  //         console.log(newSession);

  //         this.httpClient.post<any>(ADD_SESSION_API, newSession, { headers }).subscribe(data => {
  ...
  addRate() {
    ...
    const regtype: RegtypeData = this.regtypesList.find((regtype: RegtypeData) => regtype.description === this.customPackageForm.value?.regtype);
    const eventCost: EventCostData = {
      refCodes: regtype.code + " - " + regtype.description,
      rates: rate,
      customPackage: {
        name: this.customPackageForm.value.name,
        description: this.customPackageForm.value.description,
        cost: this.customPackageForm.value.isZero ? 0 : this.customPackageForm.value.cost,
        isZero: this.customPackageForm.value.isZero,
      }
    };

    console.log("this.customPackageForm.value.isZero,", this.customPackageForm.value.isZero)

    /** Check the form validation */
    let valid = true;
    let alert = '';
    if (
      this.customPackageForm.invalid ||
      this.eventDuringEventBirdCostForm.invalid ||
      (!this.isEventEarlyBirdCostFormHidden && this.eventEarlyBirdCostForm.invalid) ||
      (!this.isEventPreEventBirdCostFormHidden && this.eventPreEventBirdCostForm.invalid)
    ) {
      alert = 'Please fill all the fields with the correct value';
      valid = false;
    }
  ...
  /** reset rate package forms */
  resetRate() {
    this.customPackageForm.controls.regtype.setValue("");
    this.customPackageForm.controls.name.setValue("");
    this.customPackageForm.controls.description.setValue("");
    this.customPackageForm.controls.cost.setValue("0");
    this.customPackageForm.controls.isZero.setValue(false);
    ...
    this.customPackageForm.controls.regtype.setErrors(null);
    this.customPackageForm.controls.name.setErrors(null);
    this.customPackageForm.controls.description.setErrors(null);
    this.customPackageForm.controls.cost.setErrors(null);
    this.eventEarlyBirdCostForm.controls.earlyBirdStartDate.setErrors(null);
    this.eventEarlyBirdCostForm.controls.earlyBirdEndDate.setErrors(null);
    this.eventEarlyBirdCostForm.controls.earlyBirdRate.setErrors(null);
  ...
  public createEvent() {
    const questions = this.questionResult?.map((item) => {
      item['demDetails'] = [
        ...new Map(
          item['demDetails']?.map((v) => [v.dedDescription, v])
        )?.values(),
      ];
      return {
        ...
        columns: item['columns'] ? item['columns'] : 1,
    ...
    /*this.customPages.forEach(page => {
      this.pageBuilder.push({
        "evtUid": page.evtUid || this.myEventID,
        "eventName": page.pageName,
        "evtType": page.pageName.toLowerCase().replaceAll(' ', '-'),
        "menuName": page.menuName,
        "eventBuilderUuid": this.builderIOID
    ...
    this.builderTemplate.forEach((template) => {
      for (let key in template) {
        if (!this.builderTemplateProperties.includes(key)) {
          delete template[key];
        }
      }
    });

    console.log('exhibitorId ' + this.exhibitorIOID);
    console.log('exhibitorSelection ' + this.exhibitorSelection);
    ...
    console.log(this.EDIT_EVENT_API);
    var combinedDiscounts = this.dollarDiscountFields;
    //combinedDiscounts = combinedDiscounts + this.percentageDiscounts;
    console.log(combinedDiscounts);
    this.myNewEvent['discounts'] = combinedDiscounts;
    this.loading = true;
    this.httpClient
      .post<any>(this.EDIT_EVENT_API, this.myNewEvent, { headers })
      .subscribe(
        (data) => {
          console.log(data);
          if (data?.statusMessage === 'Success') {
            this.setNotifications(
              "The event, <a href='/event/" +
                this.myEventID +
                "/'>" +
                this.eventName +
                '</a> has been changed!'
            ...
            alert('Failed to edit the event. Try again.');
            this.loading = false;
          }
        },
        (error) => {
          // If "FAILED" with a 400 error happens, display stop execution and display error to User
          this.errorCode = error;
          alert('There was an error editing your event. Try again.');
          this.loading = false;
          console.log(error);
        }
      );
  ...
  ngOnInit(): void {
    ...
    if (this.sessionService.get('mode') != undefined) {
      this.isReadMode =
        this.sessionService.get('mode') == 'view' ? true : false;
      if (this.isReadMode) {
        this.displayTabs = {
          psmTab: false,
          eventInfoTab: true,
      ...
      this.sessionService.remove('mode');
      if (this.isReadMode) {
        this.eventInfoForm.disable();
        this.sessionForm.disable();
        this.pageBuilderForm.disable();
        this.eventEarlyBirdCostForm.disable();
        this.eventPreEventBirdCostForm.disable();
        this.eventDuringEventBirdCostForm.disable();
        this.customPackageForm.disable();
        let ifram = document.getElementsByTagName('iframe');
        let builderBtns = document.getElementsByClassName('builderBtns');
        console.log(builderBtns);
        ifram[0].style.pointerEvents = 'none';
        for (let i = 0; i < builderBtns.length; i++) {
          let e: any = builderBtns[i];
    ...
    $(function () {
      ...
      $('.tab-nav-link').bind('click', function (e) {
        // console.log(this.createdEventComplete);
    ...
    this.mdbTable.setDataSource(this.questionElements);
    ...
    // this.mdbGoalTable.setDataSource(this.goalElements);
    // this.previousGoal = this.mdbGoalTable.getDataSource();
    // this.goalElements = this.mdbGoalTable.getDataSource();
  }
    ...
    this.httpClient.get(GET_ALL_EVENTS, { headers }).subscribe((data) => {
      if (data['response']['Error'] != undefined) {
        ...
        response.forEach((event) => {
          if (this.myEventID != event.evtUid)
  ...
  formValidation(): void {
    this.eventInfoForm = this.fb.group({
      ...
      country: [this.defaultCountry, [, Validators.maxLength(40)]],
      countryCode: ['', [, Validators.maxLength(40)]],
    ...
    this.eventEarlyBirdCostForm = this.fb.group({
      earlyBirdStartDate: ['', [Validators.required]],
      earlyBirdEndDate: ['', [Validators.required]],
      earlyBirdRate: ['', [Validators.required, Validators.max(9999)]],
    });

    this.eventPreEventBirdCostForm = this.fb.group({
      preEventBirdStartDate: ['', [Validators.required]],
      preEventBirdEndDate: ['', [Validators.required]],
      preEventBirdRate: ['', [Validators.required, Validators.max(9999)]],
    });
  ...
  enableTab(tabName, validCheckReq: boolean = true) {
    ...
    window.scroll(0, 0);
    if (!this.isReadMode && validCheckReq) {
      if (
        tabName === 'regtypesTab' &&
        (this.isEventNameFound() ||
          ...
          this.isTimeOutOfOrder(
            ...
            this.eventInfoForm.get('startTime').value,
            this.eventInfoForm.get('endTime')
          ))
      ) {
        this.markFormGroupTouched(this.eventInfoForm);
        this.addDiscountTypeRef.control.touched = true;
        alert('Please fill all mandatory fields in Event Info');
        return;
      }
      ...
      if (
        ...
        if (anySessionInvalid) {
          alert('Please Enter Valid Values into highlighted sessions');
          return;
        }
      }

      if (tabName === 'qualificationTab' && this.checkIfRegtypeExists()) {
        alert('One or more discounts are missing a reg type');
        return;
      }
      ...
      // if (tabName === 'themingTab' && !this.builderIOID){ //this.pageBuilderForm.controls.main.invalid) {
      ...
      // if (
      //   tabName === 'customizationsTab' &&
      //   (this.isQuestionResultBtnDisabled || this.isGoalResultBtnDisabled)
      // ) {
      //   alert('Please select at least one Goal and at least one Question');
      //   return;
      // }
    }
  ...
  validateSelectedQuestion() {
    for (let i of this.questionResult) {
      if (
        ...
        alert(`Response is missing in '${i.question}' for '${i.category}'`);
        return false;
      }
    }
    return true;
  ...
  isTabValidate(tabName, clickedOnTab ?): boolean {
    ...
    if (
      ...
      this.markFormGroupTouched(this.eventPreEventBirdCostForm);
      this.markFormGroupTouched(this.eventDuringEventBirdCostForm);
      alert('Please fill all mandatory fields in Event Costs');
      return false;
    }
    if (
      tabName === 'packagesTab' &&
      ...
      alert('Please check the dates in Event Costs');
      return false;
    }
  ...
  isEventCostBtnDisabled() {
    // if (this.regTypesToDisplay.length < 1) {
    //   return true;
    // }

    if (this.eventEarlyBirdCostForm.valid) {
      return this.eventEarlyBirdCostForm.valid;
    }
    if (this.eventPreEventBirdCostForm.valid) {
      return this.eventPreEventBirdCostForm.valid;
    }
    if (this.eventDuringEventBirdCostForm.valid) {
      return this.eventDuringEventBirdCostForm.valid;
    }
  ...
  editQuestions(customQuestionModel, values) {
    ...
    this.responseLayout = patchValue.responseLayout;
    if (
      this.responseLayout == 'Dropdown' ||
      this.responseLayout == 'CheckboxList' ||
      this.responseLayout == 'RadioButtonList'
    ) {
      this.addNewRowResp = true;
    } else if (this.responseLayout == 'Freetext') {
  ...
  saveQuestion() {
    ...
    let dup = false;
    this.allQuestions.map((question: QuestionData, key) => {
      if (
  ...
  viewPublished() {
    if (this.isReadMode) {
      window.open(this.viewPublishedUrl, '_blank').focus();
    } else {
      if (this.builderUrl) {
  ...
  editEventCosts(eventCost, i) {
    ...
    this.customPackageForm.setValue({
      ...eventCost.customPackage,
      isZero: eventCost.customPackage.isZero || false,
      cost: eventCost.customPackage.isZero ? 0 : eventCost.customPackage.cost,
  ...
  createDuplicateEvent() {
    ...
    console.error("this.myEventID: ", this.myEventID);
    createDuplicateEventModalRef.componentInstance.evtUid = this.myEventID;
    createDuplicateEventModalRef.componentInstance.events = this.events;
    createDuplicateEventModalRef.result.then((qualification: any) => {
      console.error('New Created duplicate Event: ', qualification);
    });
  }
