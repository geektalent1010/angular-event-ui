...
@Component({
  ...
  styleUrls: ['./event-pages.component.scss'],
  providers: [DatePipe]
})
...
// 2299188
  ...
  ngOnInit(): void {
    ...
    this.paramEventId = this.activatedRoute.snapshot.params.eventId;
    ...
    this.httpClient.get(EVENT_DATA_API1, { headers }).subscribe(data => {
      ...
      if (data && data['response'] && data['response']['Event']) {
        ...
        console.log("builderUrl: " + this.builderUrl);
        this.thisURL = this.builderUrl;
        this.iframeSrc = this.sanitizer.bypassSecurityTrustResourceUrl(this.thisURL);
      }
    });
    ...
    //    // console.log(data['response']['evtList'][0]['builderId']);

    //     this.eventID = data['response']['evtList'][0]['evtUid'];
    //     this.eventType = data['response']['evtList'][0]['evtType'];
    //     this.eventName = data['response']['evtList'][0]['evtName'];
    //     this.tradeShowEvent = data['response']['evtList'][0]['tradeShowEvent'];

    //     this.eventInfoText = data['response']['evtList'][0]['eventInfoText'];
    //     this.showStartDate = data['response']['evtList'][0]['showStartDate'];
    //     this.showEndDate = data['response']['evtList'][0]['showEndDate'];
    //     this.typeEvent = data['response']['evtList'][0]['tradeShowEvent'];

    //     this.eventInviteOnly = data['response']['evtList'][0]['evtInviteOnlyFlag'];
    //     this.eventCode = data['response']['evtList'][0]['eventInvitedCd'];

    //     //default test theme
    //     this.builderIOID = data['response']['evtList'][0]['builderId'];

    //     this.modalPopupTrigger.nativeElement.click();

    //     this.getRegUid();

    //     this.calendarChild.updateEventUid(this.eventID);

    //     var GET_BUILDER_UUID_API = API_URL + "/csi/event/services/event/getBuilderUuidsForEvent?evtUid=" + this.eventID;
    //     console.log(GET_BUILDER_UUID_API);

    //     this.httpClient.get(GET_BUILDER_UUID_API, { headers }).subscribe(data2 => {
    ...
    //         this.customPages = data2['response']['BuilderPageInfoList'];

    //         for (const key in data2['response']['BuilderPageInfoList']) {

    //           if (data2['response']['BuilderPageInfoList'][key]['evtUid'] == this.eventID) {

    //             if (this.pageKey == data2['response']['BuilderPageInfoList'][key]['evtType']) {
    //               this.builderIOID = data2['response']['BuilderPageInfoList'][key]['eventBuilderUuid'];
    //               break;
    //             }
    ...
    //       this.thisURL = "https://builder.io/content/" + this.builderIOID + "?apiKey=bpk-a24f8e79c5ef4ae3aa9a0167b9430517";
    //       this.safeURL = this.sanitizer.bypassSecurityTrustResourceUrl(this.thisURL);

    //       this.getExhibitorsList(this.paramID);
    //       this.getAllSessions();
    //     });

    //     // Could set this up to be a variable passed
    //     var fontColor = "#000";

    //     $("#main-wrapper").hide();

    //     $('#eventID').val(this.eventID);
  ...
  populateQuestions(category, subcategory){
    const feedbackQuestions = {
      "Exhibitor":[
       ...
       "Staff":[
        {
          "question": "How do you want to collect information from Attendees?"
        },
        {
          "question": "What information do you want collected from attendees?"
        },
        {
          "question": "Do you have any incentives for Attendees?",
          "options": [
              "Yes",
              "No",
            ]
       ...
       "Product Manager":[
        {
          "question": "Are you interested in receiving product feedback of what is being sold?",
          "options": [
              "Yes",
              "No",
            ]
        ...
        {
          "question": "Are there any incentive programs for attendees to drive them to your booth?",
          "options": [
              "Yes",
              "No",
            ]
       ...
       "Speaker":[
        {
          "question": "Are you interested in receiving feedback during speaking sessions?",
          "options": [
              "Yes",
              "No",
            ]
       ...
       "Corporate":[
        {
          "question": "How many employees do you want to attend the event?",
          "options": [
            '0 - 5',
            '5 - 10',
            '100 - 250',
        ...
        {
          "question": "How many booths per day do you want employees to engange?",
          "options": [
            '0 - 5',
            '5 - 10',
            '100 - 250',
        ...
        {
          "question": "How many sessions do you want employees to attend per day?",
          "options": [
            '0 - 5',
            '5 - 10',
            '100 - 250',
        ...
        {
          "question": "What types of exhibitors is it important for employees to attend?",
        },
        {
          "question": "What types of exhibitors is it important for employees to attend?",
        },
       ...
       "Student":[
        {
          "question": "Did you learn the information you were looking for?",
          "options": [
              "Yes",
              "No",
            ]
        ...
        {
          "question": "What types of sessions are you interested in?",
          "options": [
              "Yes",
              "No",
            ]
        ...
        {
          "question": "Where you able to receive a certification (if applicable)?",
        },
       ],
       "Media":[
        {
          "question": "How many stories are you interested in writing regarding this event?",
          "options": [
            '0 - 5',
            '5 - 10',
            '100 - 250',
        ...
        {
          "question": "How many exhibitors do you want to engage with?",
          "options": [
            '0 - 5',
            '5 - 10',
            '100 - 250',
        ...
        {
          "question": "What are your core coverage areas?",
        },
       ],
    };
...
//  }
  ...
  open(content) {
    ...
    const config: ModalOptions = { class: 'modal-dialog', ariaLabelledBy: 'modal-basic-title'};
