export const sessionTopicsOptions: string[] = [
  'AGRICULTURE & FARMING',
...
export const languageCodes = [
    { "language": "French", "code": "French" },
    { "language": "English", "code": "English" },
    { "language": "Spanish", "code": "Spanish" },
    { "language": "Portuguese", "code": "Portuguese" },
    { "language": "Korean", "code": "Korean" },
    { "language": "Italian", "code": "Italian" },
    { "language": "Japanese", "code": "Japanese" },
    { "language": "German", "code": "German" },
    { "language": "Chinese", "code": "Chinese" },
    { "language": "Swedish", "code": "Swedish" },
    { "language": "Hindi", "code": "Hindi" },
]